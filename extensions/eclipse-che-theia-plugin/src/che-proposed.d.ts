...
declare module '@eclipse-che/plugin' {
    ...
    export namespace test {
        export namespace languageserver {
            ...
            export function implementation(pluginID: string, resource: UriComponents, position: Position, token: theia.CancellationToken): Promise<Definition | DefinitionLink[] | undefined>;
            export function typeDefinition(pluginID: string, resource: UriComponents, position: Position, token: theia.CancellationToken): Promise<Definition | DefinitionLink[] | undefined>;
            export function definition(pluginID: string, resource: UriComponents, position: Position, token: theia.CancellationToken): Promise<Definition | DefinitionLink[] | undefined>;
            export function declaration(pluginID: string, resource: UriComponents, position: Position, token: theia.CancellationToken): Promise<Definition | DefinitionLink[] | undefined>;
